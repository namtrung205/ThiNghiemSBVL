...
namespace RuntimeGizmos
{
	...
	public class TransformGizmoOnLyRoX : MonoBehaviour
	{
		//Toan tu chuyen doi ngam dinh
		public static implicit operator TransformGizmo (TransformGizmoOnLyRoX myTransformGizmo)
		{
		...
		public KeyCode SetMoveType = KeyCode.M;
		...
		public float allMoveHandleLengthMultiplier = 0.0001f;
		public float allRotateHandleLengthMultiplier = 1.5f;
		public float allScaleHandleLengthMultiplier = 0.0001f;
...
//			DrawQuads(circlesLines.z, GetColor(TransformType.Rotate, this.zColor, zColor));
		...
		void GetTarget()
		{
			if(nearAxis == Axis.None && Input.GetKey(KeyCode.T))
			{
